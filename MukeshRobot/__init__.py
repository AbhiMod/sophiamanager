...
if ENV:
    ...
    TOKEN = os.environ.get("TOKEN", "6129232106:AAFnvrcgz5J9Ja-bW1H6Rtb4hE6oRF6aD6Q")
    ...
    try:
        ...
        DEV_USERS = set(int(x) for x in os.environ.get("DEV_USERS", "2145093972","6204761408").split())
    except ValueError:
