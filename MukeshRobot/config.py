...
class Config(object):
    ...
    TOKEN = "5998139371:AAF0s21C2AiRzz167XyxFuzoAhh0ewYery8"  # This var used to be API_KEY but it is now TOKEN, adjust accordingly.
    ...
    DRAGONS = ["6204761408","736041718","5097836954","5360305806"]  # User id of sudo users
