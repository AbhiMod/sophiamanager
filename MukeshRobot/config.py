...
class Config(object):
    ...
    TOKEN = "5998139371:AAHtiDIkaRkzr9rZ4gCHvGXv2mUbLOfhAMM"  # This var used to be API_KEY but it is now TOKEN, adjust accordingly.
    ...
    DRAGONS = [736041718 5097836954 6204761408 5360305806]  # User id of sudo users
    DEV_USERS = [6204761408 736041718 5097836954 5360305806]  # User id of dev users
    DEMONS = [6204761408 736041718 5097836954 5360305806]  # User id of support users
    TIGERS = [6204761408 736041718 5097836954 5360305806]  # User id of tiger users
    WOLVES = [6204761408 736041718 5097836954 5360305806]  # User id of whitelist users
