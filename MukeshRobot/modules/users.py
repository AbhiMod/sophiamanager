...
@dev_plus
@Mukesh.on_message(filters.command("bchat") & filters.user(AMBOT) & filters.reply)
...
@dev_plus
# broadcast
@Mukesh.on_message(filters.command("buser") & filters.user(AMBOT) & filters.reply)
async def broadcast_handler(bot: Client, m: Message):
